    ...
    def start_loop(self, companyName=None, companyCapital=None, loadPreviousGame=None):
        ...
        if companyName is not None:
            ...
            if companyName in sol.companies.keys():
                ...
                model_companyName = random.choice(list(sol.companies.items()))[0]
                model_company = sol.companies[model_companyName]
                new_company = company.company(sol, model_company.company_database, deviation=5, companyName=companyName,
        ...
        message_rect = pygame.Rect(10, global_variables.window_size[1] - 100, global_variables.window_size[0] - 170,
                                   100)
        ...
        while True:
            ...
            if sol.display_mode == "solar_system":
                ...
                if gui_instance.active_window is not None:
                    ...
                    right_rect = pygame.Rect(gui_instance.active_window.rect[0] + gui_instance.active_window.rect[2], 0,
                                             global_variables.window_size[0] - gui_instance.active_window.rect[0] -
                                             gui_instance.active_window.rect[2], global_variables.window_size[1])
                    top_rect = pygame.Rect(0, 0, global_variables.window_size[0], gui_instance.active_window.rect[1])
                    bottom_rect = pygame.Rect(0,
                                              gui_instance.active_window.rect[1] + gui_instance.active_window.rect[3],
                                              global_variables.window_size[0],
                                              global_variables.window_size[1] - gui_instance.active_window.rect[3] -
                                              top_rect[3])
